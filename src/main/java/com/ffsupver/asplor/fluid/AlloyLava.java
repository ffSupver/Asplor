...
public abstract class AlloyLava extends FlowableFluid {
    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_ALLOY_LAVA;
    }

    @Override
    public Fluid getStill() {
        return ModFluids.ALLOY_LAVA;
    }
    ...
    public Item getBucketItem() {
        return ModItems.ALLOY_LAVA_BUCKET;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return AllBlocks.ALLOY_LAVA.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends AlloyLava {
        public Flowing() {
        }
    ...
    public static class Still extends AlloyLava {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
