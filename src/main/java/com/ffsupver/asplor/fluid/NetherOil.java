...
public abstract class NetherOil extends FlowableFluid implements GenerateBlockWhenLava{
    @Override
    ...
    public Item getBucketItem() {
        return ModItems.NETHER_OIL_BUCKET;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) AllBlocks.NETHER_OIL.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        if (direction == Direction.DOWN) {
            ...
            if (fluidState2.isIn(ModTags.Fluids.REFINED_OIL) || fluidState2.isIn(FluidTags.LAVA)) {
    ...
    public static class Flowing extends NetherOil {
        public Flowing() {
        }
    ...
    public static class Still extends NetherOil {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
