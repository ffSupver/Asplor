...
public abstract class ConcentratedOilFluid extends FlowableFluid implements GenerateBlockWhenLava{
    ...
    public Fluid getStill() {
        return ModFluids.CONCENTRATED_OIL;
    }
    ...
    public Item getBucketItem() {
        return ModItems.CONCENTRATED_OIL_BUCKET;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return AllBlocks.CONCENTRATED_OIL.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
...
//            System.out.println(fluidState2+" "+fluidState2.isIn(FluidTags.WATER)+" "+fluidState2.isIn(ModTags.Fluids.REFINED_OIL)+" "+pos+" "+this);
    ...
    public static class Still extends ConcentratedOilFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
