...
public abstract class HeavyOilFluid extends FlowableFluid {
    ...
    public Item getBucketItem() {
        return ModItems.HEAVY_OIL_BUCKET;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return  AllBlocks.HEAVY_OIL.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
...
//            System.out.println(fluidState2+" "+fluidState2.isIn(FluidTags.WATER)+" "+fluidState2.isIn(ModTags.Fluids.REFINED_OIL)+" "+pos+" "+this);
    ...
    public static class Still extends HeavyOilFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
