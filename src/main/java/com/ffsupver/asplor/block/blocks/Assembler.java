...
public class Assembler extends Block {
    ...
    private static final Text ASSEMBLER_TITLE = Text.translatable("block.asplor.assembler");
    ...
    public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
        return new SimpleNamedScreenHandlerFactory((syncId, inventory, player) -> {
            return new AssemblerScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos));
        }
        , ASSEMBLER_TITLE);
    }
