...
public class SmartMechanicalArmRenderer extends SafeBlockEntityRenderer<SmartMechanicalArmEntity> {
    ...
    protected void renderSafe(SmartMechanicalArmEntity be, float partialTicks, MatrixStack ms, VertexConsumerProvider buffer, int light, int overlay) {
        ...
        ms.translate(-.5f,0,-.5f);
        ms.translate(0,1,0);
        renderModel(be,ms,buffer,AllPartialModels.SMART_MECHANICAL_ARM_BASE);
        ms.translate(0,-1,0);
        //整体高度
        ...
        ms.translate(0,-0.2,-1.5);
        renderModel(be,ms,buffer,AllPartialModels.SMART_MECHANICAL_ARM_FIRST_ARM);
        ...
        renderModel(be,ms,buffer,AllPartialModels.SMART_MECHANICAL_ARM_SECOND_ARM);
        ms.translate(0,0,1/16f);
        ...
        renderModel(be,ms,buffer,AllPartialModels.SMART_MECHANICAL_ARM_HEAD);
        PartialModel toolModel = be.getToolModel(isWorking);
        ms.translate(0,-6/16f,0);
        if (toolModel != null){
            renderModel(be, ms, buffer, toolModel);
        }
