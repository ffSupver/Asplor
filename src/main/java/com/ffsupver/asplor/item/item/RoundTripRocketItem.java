...
public class RoundTripRocketItem extends RenderedItem implements BotariumFluidItem<WrappedItemFluidContainer> {
    private final EntityType<? extends RoundTripRocketEntity> rocketType;
    public RoundTripRocketItem(Settings properties, EntityType<? extends RoundTripRocketEntity> rocketType) {
        super(properties);
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (level.isClient()) {
            ...
            if (!state.isIn(ModBlockTags.LAUNCH_PADS)) {
                ...
                Entity vehicle = rocketType.create(level);
                if (vehicle == null) {
                    return ActionResult.PASS;
                } else {
                    ...
                    if (vehicle instanceof RoundTripRocketEntity rocket) {
